...
fn dequantize(ctx: &mut crate::gekko::Gekko, addr: u32, ld_type: u8, ld_scale: u8) -> f64 {
...
fn quantize(ctx: &mut crate::gekko::Gekko, addr: u32, value: f64, st_type: u8, st_scale: u8) {
...
fn psq_load(ctx: &mut crate::gekko::Gekko, fd: u8, addr: u32, w: bool, gqr: u32) {
...
fn psq_store(ctx: &mut crate::gekko::Gekko, fs: u8, addr: u32, w: bool, gqr: u32) {
